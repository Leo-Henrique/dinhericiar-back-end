...
export abstract class TransactionDebitExpenseRepository {
  ...
  abstract createManyWithFixedRecurrence(
    ...
    options?: CreateManyWithFixedRecurrenceOptions,
  ): Promise<void>;
  abstract findUniqueLastOfFixedRecurrence(
    transactionRecurrenceFixed: TransactionRecurrenceFixed,
  ): Promise<TransactionDebitExpense | null>;
}

export type CreateManyWithFixedRecurrenceOptions = UnitOfWorkSessionOptions & {
